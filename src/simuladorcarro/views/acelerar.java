...
/**
 * Diálogo que muestra la animación de aceleración del vehículo
 * 
 * Muestra un GIF animado de aceleración y reproduce el sonido correspondiente
 * cuando el usuario aumenta la velocidad del vehículo
 * 
 * @author SOFIA RUDAS
 * @version 1.0.0
 * @since 12042025
...
public class acelerar extends javax.swing.JDialog {
    ...
    /**
     * Crea un nuevo diálogo de aceleración
     * 
     * @param parent Ventana padre del diálogo
     * @param modal Indica si el diálogo es modal
     * @param vehiculo Vehículo que está acelerando
     * @param ventana Referencia a la ventana principal
     */
    public acelerar(java.awt.Frame parent, boolean modal, Vehiculo vehiculo, principal ventana) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        ventana.actualizarInfoVehiculo();
        reproducirSonido("/simuladorcarro/audios/acelerando.wav");
        ImageIcon gif = new ImageIcon("/simuladorcarro/videos/acelerar.gif");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/simuladorcarro/videos/acelerar.gif"))); // NOI18N
